...
vi.mock("react-leaflet", () => ({
  Marker: ({ eventHandlers, keyboard, position, title }: { eventHandlers?: { click(): void }; keyboard?: boolean; position: [number, number]; title: string }) => <button aria-label={title} data-keyboard={keyboard} data-position={JSON.stringify(position)} onClick={eventHandlers?.click} type="button" />,
  Pane: () => null,
