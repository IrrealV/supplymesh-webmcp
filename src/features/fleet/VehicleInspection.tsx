...
export function VehicleInspection({ comparison, isFollowing, locale, onBackFromRecovery, onClose, onRestoreFollow, onReviewRecovery, onScenarioChange, onViewRoute, operations, scenario, vehicle }: InspectionProps) {
  const copy = catalog(locale);
